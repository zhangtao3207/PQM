...
// File name:           rd_id
// Created by:          正点原子
// Created date:        2025年10月8日17:50:00
// Version:             V1.0
// Descriptions:        读LCD屏ID模块
//
//----------------------------------------------------------------------------------------
//****************************************************************************************//
...
always @(posedge clk or negedge rst_n) begin
    if(!rst_n) begin
        ...
        if(rd_flag == 1'b0 && (cnt_delay == 16'd50_000)) begin
            rd_flag <= 1'b1; 
