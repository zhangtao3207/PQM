 ...
 * Function:
 *   Parameterized unsigned remainder unit based on the restoring-division
 *   algorithm. The module avoids the "%" operator and returns the remainder
 *   after WIDTH clock cycles. "done" is a one-cycle pulse.
 */
module modulo_unsigned #(
