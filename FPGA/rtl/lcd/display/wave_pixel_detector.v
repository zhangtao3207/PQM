...
/*
 * 模块: wave_pixel_detector
 * 功能:
 *   根据波形 RAM 数据判断当前像素是否落在波形线段上。
 *
 * 输入:
 *   graph_en_d1: 信号。
 *   wave_frame_valid_sync: 信号。
 *   wave_ram_dout: 信号。
 *   wave_prev_valid_d1: 信号。
 *   wave_prev_y_d1: 信号。
 *   wave_prev_col_d1: 信号。
 *   wave_prev_row_d1: 信号。
 *   graph_col_d1: 信号。
...
localparam [10:0] Y_MARGIN = 11'd1;    // Anti-alias: draw within 卤1 pixel of the line
...
assign wave_pixel_on = graph_en_d1 && wave_frame_valid_sync &&
                       (((graph_col_d1 == 9'd0) || !wave_seg_valid) ?
                           // First point: draw at current Y 卤1
