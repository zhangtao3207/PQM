...
# # AD7606 parallel ADC
# set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports OS1]
# set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports OS0]
# set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports OS2]
# set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports Convst_B]
# set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports RD]
# set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports RESET]
# set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports Busy]
# set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports cs]
# set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports Convst_A]
