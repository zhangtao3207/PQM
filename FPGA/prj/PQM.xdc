...
set_property PACKAGE_PIN T11 [get_ports adc_convst]
set_property IOSTANDARD LVCMOS33 [get_ports adc_convst]
set_property PACKAGE_PIN T5 [get_ports adc_reset]
set_property IOSTANDARD LVCMOS33 [get_ports adc_reset]
set_property PACKAGE_PIN U7 [get_ports adc_sclk]
set_property IOSTANDARD LVCMOS33 [get_ports adc_sclk]
set_property PACKAGE_PIN V8 [get_ports adc_cs]
set_property IOSTANDARD LVCMOS33 [get_ports adc_cs]
set_property PACKAGE_PIN T9 [get_ports adc_busy]
set_property IOSTANDARD LVCMOS33 [get_ports adc_busy]
set_property PACKAGE_PIN V6 [get_ports adc_frstdata]
set_property IOSTANDARD LVCMOS33 [get_ports adc_frstdata]
set_property PACKAGE_PIN Y6 [get_ports adc_douta]
set_property IOSTANDARD LVCMOS33 [get_ports adc_douta]
set_property PACKAGE_PIN Y8 [get_ports adc_doutb]
set_property IOSTANDARD LVCMOS33 [get_ports adc_doutb]
