...
#
# Generated by export_simulation on Wed Apr 01 23:41:47 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_font_10x20.sh' script.

./blk_mem_gen_font_10x20.sh -reset_run
...
./blk_mem_gen_font_10x20.sh -noclean_files

For more information on the script, please type './blk_mem_gen_font_10x20.sh -help'.
