...
#
# Generated by export_simulation on Wed Apr 01 23:38:12 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_font_16x32.sh' script.

./blk_mem_gen_font_16x32.sh -reset_run
...
./blk_mem_gen_font_16x32.sh -noclean_files

For more information on the script, please type './blk_mem_gen_font_16x32.sh -help'.
