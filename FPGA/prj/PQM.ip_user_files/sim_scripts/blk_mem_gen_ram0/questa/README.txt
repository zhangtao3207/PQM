...
#
# Generated by export_simulation on Thu Apr 02 20:44:02 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_ram0.sh' script.

./blk_mem_gen_ram0.sh -reset_run
...
./blk_mem_gen_ram0.sh -noclean_files

For more information on the script, please type './blk_mem_gen_ram0.sh -help'.
